...
import type { Order, Appointment, OrderLineItem, OrderTransaction } from '@opencals/storefront-sdk';
...
function ThankYouContent() {
	...
	const appointments: Appointment[] = order?.appointments ?? [];
							...
							<div className="border border-charcoal/10 p-6">
								...
								<div className="mt-4 space-y-3">
									...
									<div className="flex justify-between text-sm">
										...
										<span className={`font-medium ${order?.isFullyPaid ? 'text-green-600' : 'text-amber-600'}`}>
